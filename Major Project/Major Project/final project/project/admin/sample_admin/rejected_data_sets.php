...
<li class="active"><span>Rejected Road Accident Prediction</span></li>
</ol>
</div>
<!-- /Breadcrumb -->
</div>
...
<div class="pull-left">
<h6 class="panel-title txt-dark">Rejected Data Sets</h6>
</div>
...
<?php 
	...
	$prdquery = mysqli_query($conn,"SELECT * FROM accident_prediction WHERE prediction_status='Rejected'");
